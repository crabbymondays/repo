...
Download `curatr-1.0.0-github-source.zip` to Android's Downloads folder, then
run:
...
unzip -q ~/storage/downloads/curatr-1.0.0-github-source.zip -d "$release_tmp"
...
git commit -m "Release curatr 1.0.0"
