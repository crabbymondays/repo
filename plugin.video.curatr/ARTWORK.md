...
Appearance setting selects the clean white files or the independent curatr
colour menu set in `theme_curatr_v2/`.
...
- `resources/media/list_art/icons_colour_v3/` contains matching square Genre
  Colours icons derived from the approved generated genre backgrounds.
...
List records store icon style, icon mode, fanart style and fanart mode
separately. Global menu appearance never changes list artwork. Manual selections are
